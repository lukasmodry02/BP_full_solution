...
public partial class ChessFiguresClassification
{
    /// <summary>
    /// model input class for ChessFiguresClassification.
    /// </summary>
    ...
    /// <summary>
    /// model output class for ChessFiguresClassification.
    /// </summary>
    ...
    private static string MLNetModelPath = Path.GetFullPath("ChessFiguresClassification.mlnet");

    public static readonly Lazy<PredictionEngine<ModelInput, ModelOutput>> PredictEngine = new Lazy<PredictionEngine<ModelInput, ModelOutput>>(() => CreatePredictEngine(), true);


    public static void PrintLabelIndexMapping()
    {
        var dummy = new ModelOutput { Score = new float[13] };
        var labels = GetLabels(dummy).ToList();

        for (int i = 0; i < labels.Count; i++)
        {
            Console.WriteLine($"Index {i}: \"{labels[i]}\"");
        }
    }
